...
// The car dealer has all of their inventory housed in the array seen below.  Scroll down past 
//the data to find out how you can help the car dealer.
...
//find out which car has an id of 33 by logging the car's year, make, and model in the console log 
//provided to you below:
let year = inventory[32].car_year;
let make = inventory[32].car_make;
let model = inventory[32].car_model;
...
for(let j =0; j < inventory.length; j++){
    if(inventory[j] === inventory[32]){
        console.log(`The car model year${inventory[j]}`);
    }
};
...
//const models = inventory.sort(function(a, b){
...
//inventory.forEach(car => carModels(push.car_models));

// or this 

//const counterFactory = () => {};

//  let increment = () => count_num += 1;
// let decrement = () => count_num -= 1;
...
//let carYears = inventory.sort(function(a, b) {
//    return a - b;
//});
